            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    ...
                    <div class="travel-gallery-wrapper">
                        <div class="row">
                            <div v-for="(item,index) in goodsList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 col-lg-3">
                                <div class="single-gallery-item" @click="jumpCheck('../goods/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="img-box">
                                        <img :src="item.goodsPhoto?item.goodsPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <b class="location" v-if="item.goodsNewMoney">
                                    ...
                                    <div class="content">
                                        <h5 class="catagory">
                                            <b style="color: inherit">{{item.goodsName}}</b>
                                        </h5>
                                    </div>
                                </div>
                            </div>

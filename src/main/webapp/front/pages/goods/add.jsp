        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.goodsName"--%> type="text" name="goodsName" id="goodsName" placeholder="商品名称" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.goodsKucunNumber"--%> type="text" name="goodsKucunNumber" id="goodsKucunNumber" lay-verify="integer|required"   placeholder="商品库存" autocomplete="off" class="layui-input">
                </div>
            </div>

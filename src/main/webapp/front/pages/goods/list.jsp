            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="goodsName" id="goodsName" placeholder="商品名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                ...
                <div class="ng-inside-box ng-fault ng-container" aos="fade-up">
                    <div class="project-sec pt-100 pb-70">
                        <div class="row">
                            <div v-for="(item,index) in dataList" v-bind:key="index" class="col-md-3 col-sm-6">
                                <div class="item" @click="jumpCheck('../goods/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="project-thumb">
                                        <img :src="item.goodsPhoto?item.goodsPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="project-hoverlay">
                                            <div class="project-text">
                                                <h3 v-if="item.goodsNewMoney">
                                                    {{item.goodsNewMoney}} RMB
                                                </h3>
                                                <h3 v-else>
                                                    {{item.goodsValue}}
                                                </h3>
